 ...
 *
 * To say the truth: This is nearly the orginal Viewhelper of EXT:Form.
 * Only the calculation of the columns width is adapted.
 * The reason? Bootstrap uses something like `col-xs-6` to use 50% of width
 * while tailwindcss uses `xd:w-1/2`.
 * So it's necessary to calculate $gridsize / $usedColumns
 */

namespace Rintisch\TailwindcssForm\ViewHelpers;
